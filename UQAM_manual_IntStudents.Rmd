...
author: "CarBBAS"
date: "Last updated on: 08 May 2020"
output:
  html_document:
    toc: true
    toc_depth: 3
...
The system works here, that usually you need to go to a generalist first and get a referal to a specialist. So, usually people see their family doctor. It is hard to find a family doctor in Montréal, however, there are several walk-in clinics for people without a family doctor. Some walk-in clinics are without appointments (expect long waiting hours) or with appointment.
...
On the more private note, we also have a Whatsapp group to communicate among students and post-docs. Again ask to be joined!
...
To get access to **ArcGIS** send an email to [geolab@uqam.ca](<mailto:geolab@uqam.ca>) to ask for the instructions.
...
## GRIL member
We are part of an interuniversity limnology research group called [GRIL](https://oraprdnt.uqtr.uquebec.ca/pls/public/gscw030?owa_no_site=543). And usually every student and post-doc joins this society. We also have an **Annual symposium** around March and a **student workshop** in autumn called ÉcoLac.
