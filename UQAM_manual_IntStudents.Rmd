...
version: "v.3.1"
date: 'Last updated on: 04 October 2022'
output:
  pdf_document:
    toc: yes
    toc_depth: '3'
...
* [Metro-Medic](http://www.metromedic.com/)
  (Payment: CAD$140, used to directly get the money from Desjardins if you had a 'attestation d'insurance maladie' but not any more since 2021)
  Pros: Open 7 days a week, English-speaking and appointment via email [info@metromedic.com](info@metromedic.com), you'll get an appointment usually on the next day.
  If you go late in the evening and get a prescription for drugs the Pharmaprix close to the clinic on 1500 Rue St-Catherine W is open 24h.
...
* Urology:
  * [RocklandMD](https://www.rocklandmd.com/en/) - 
    Dr. Genevieve Desbiens; Town of Mount Royal Clinic - Doctor was very nice, speaks English. Consultation expensive CAD$325 and above what Desjardins covers. They will refund around CAD$250. Appointment: fill appointment request online.
* Gynecology:
  * [Curel-Med](http://www.curelmed.ca/) - 
    Dr. Pira Korsieporn - very nice doctor, speaks English. Clinic reception not very friendly. Appointment: online.
...
* Ultra-sounds, MRI etc:
  * [IRM Sud-Ouest](https://mobi.irmsudouest.com/) - Friendly staff, English speaking. Appointment: best to call.
  * [Leger Radiologie](https://legerradiologie.qc.ca/) - Accepts RAMQ, only French, Appointment: best call or email.
  
* Other lab tests:
  * [Dynacare](https://www.dynacare.ca/find-a-location.aspx) - Has many labs across Montreal. Easy online booking.
  
Most of these offer lab tests that are covered at 100% by Desjardins Insurance.

**Dentists**:

Once a year, you can get a cleaning treatment and if you choose your dentist wisely with some student discount, the treatment can become free of charge.
...
*Update*: Now, you can order all documents from UQAM needed for extending the study permit online. Consult this [webpage](https://etudier.uqam.ca/commande-documents-officiels-instructions).
...
## 13. Budget and living expenses {#budget}
