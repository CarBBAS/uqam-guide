...
author: 'Authors: See [contributor](#contributors) list'
version: "v.3.2"
date: 'Last updated on: 17 January 2023'
output:
  pdf_document:
    toc: yes
    toc_depth: '3'
...
> If you have questions, rather than calling Immigration, Refugees and Citizenchip Canada (IRCC) via phone, their Twitter seems to be much more responsive. You can contact their [French](https://twitter.com/CitImmCanFR) or [English](https://twitter.com/CitImmCanada) account.
...
**Online**, now you can submit the "Demande de versement de bourse" online:

 ![](./Photos/stipend_form.png)

When they enter the student's permanent code, the rest of the student's personal info that UQAM has on file will auto-fill in the form, so the student may only need to give their supervisor their permanent code. Unfortunately you can't receive your bourse until you are registered for the semester and are in Canada with a Canadian address and bank account. Since registration opens only a couple of weeks before the start of the next semester, this is the earliest that we can prepare the bourse forms. With the online system it will still take 4-6 weeks to process the bourse request.
...
If you cannot sign up for direct deposit at first, you will get your first payment via a cheque. Most of the bigger banks have a cheque deposit function through their official phone application. In this way, you can easily deposit the cheque immediately into your account without having to go to a bank branch.
...
*Update*: Since COVID application for a new student card or renewal is *online*. You'll have to take a picture yourself and you can then pick it up at the UQAM student card office below the UQAM registrariat. Details can be found [here](https://coci.uqam.ca/).
...
To get a cheaper fare for public transport is to get a student OPUS card. You will be able to purchase a cheaper 1-month and 4-month pass.
...
> Tip: For PhD students, you will finish paying your tuition fees in three years. In your 4th year, you will be exempt of tuition for one year. Starting with your 5th year, you will have to pay a fixed fee of around $411 as tuition in addition to the administrative fees.
...
> Tip: If they ask for an official transcript of your notes, make sure you do not download what you can find on the portail etudiant. Instead, you will have to pay and ask for an official document. You can order official documents [here](https://etudier.uqam.ca/commande-documents-officiels-instructions).
...
Some clinics may ask you for a 'attestation d'assurance maladie' that shows an official start and end date of your insurance, hence, this document will expire after every year. You can send an email to [sve-accueil@uqam.ca](sve-accueil@uqam.ca) to ask for this document.
...
Recently, Desjardins started accepting submitting claims online even for Doctor visits besides Dentists, Chiropractor etc.

For Dentists, Chiropractors, Vision care you can easily submit a form via your online portal on the Desjardins website (login [here](https://www.agea-gbim.dsf-dfs.com/AGEA-GBIM/Athntfctn/Accl/Accueil_Home.aspx)).

For any other doctor visits, you have to fill in the ["Claim for health care benefits"](https://www.desjardinslifeinsurance.com/en/forms/Documents/Claim_Health_Care_Benefits_19132A.pdf). Make sure to take this form with you when you visit the doctor. Keep the signed form and the invoice you will receive. Previously, the claim had to be sent via post mail to the Desjardins company. However, it seems that now, you can submit it online through this [webpage](http://www.desjardinslifeinsurance.com/send).
 
And follow these steps:
 ![](./Photos/Desjardins_onlineclaim.png)
...
### 16. Extending your CAQ/study permit
...
You will need to provide the number of your previous study permit/CAQ as well.

If you initially received a stipend to study and the stipend is finished, make sure to change the responsible to pay for your stay not as 'myself' but 'An organization or government' and enter your PI's name and UQAM address.

Additionally, you will need to ask UQAM for documents to prove that you are currently a student. Visit the registrar to get all your documents. If you tell them that you need all the documents to renew your study permit, they will give you what you need. You will have to pay for the documents (~CAD$30). Make sure to scan your UQAM documents. Both CAQ application, and study permit applications are online now.

*Update*: Now, you can also order all documents from UQAM needed for extending the study permit online. Consult this [webpage](https://etudier.uqam.ca/commande-documents-officiels-instructions). (Takes about a week to mail)

You will need to order:

* Relevé de notes officiel
* Attestation d'inscription (un trimestre) à temps complet (most recent semester)
* Attestation d'inscription (plusieurs trimestres - en tableau)

(If you're short on time, you can still go to the UQAM registrar to immediately get your documents)

---

#### Check your passport

Check if your passport is valid for the whole duration of your extension. If not, renew before extension. 
**Unlike the study permit, the CAQ is not bound to a specific passport.** So you are able to apply to the CAQ extension while you are renewing your passport. However, it is important that you apply to the CAQ before your old passport expires! It's probably best, to include an explanatory letter that you are waiting for the renewal of your passport.

#### CAQ

There is a detailed step-by-step video on YouTube by the Government of Quebec (in French) to guide you through the creation of your application to the depositing your files on Arrima ([here](https://www.youtube.com/watch?v=RsQ6OvDlzWE)).

 - Complete your online application for temporary selection for studies [here](https://www.form.services.micc.gouv.qc.ca/dcae/faces/faces/pages/identite1.jspx?lang=en). You will need to pay **$120**.
 - Create a profile on [Arrima](www.immigration-quebec.gouv.qc.ca/en/informations/arrima/): Make sure your profile name on Arrima is exactly the same as your online application for temporary selection for studies.
 - Access your online application file [here](https://www.form.services.micc.gouv.qc.ca/dossierClient/faces/pages/authentification.jspx?lang=en&app=DCAE&indCreationCompte=undefined&indCodeAutorisation=undefined) and retrieve your file number
 - They will provide a check-list of documents needed, make sure to upload all documents on Arrima.
 
 Current required documents are:
 
 - Declaration, commitments and authorization form, dated and signed (1st page of the checklist they send)
 - Legible copy of pages of your passport bearing personal information and the photo. **Passport must be valid on the date of application.**
 - Official letter from registrar that you are a full-time student and the number of credits obtained
 - Official transcripts of grades for the entire period of validity of your CAQ for studies
 - Proof of financial capacity (Letter from your supervisor to give you money or an official letter from scholarship)
 - (Additional: You can include your payment proof for the last three semesters from UQAM to show that you are receiving money. Download the proofs on the human resources website [here](https://rhu.uqam.ca/index.aspx?id=p693). Choose 'Relevé de paie' and choose 'without Code MS' to log-in.)
 
Once you receive the online approval of your CAQ, apply to extend your study permit.

#### Study permit

  - If you are a US citizen or permanent resident, you can apply to the study permit at a border of entry (POE).
  - Otherwise, you need to apply online.
 
If any of the links are broken, they updated links might be on the [Quebec government webpage](https://www.quebec.ca/en/education/study-quebec).

Step-by-step:

- Log-in to your account that you used to initially apply for a study permit [here](https://www.canada.ca/en/immigration-refugees-citizenship/services/application/account.html)
- Go through the questionnaire
- Once you fill the questionnaire, the portal provides you with all the documents you need. Make sure you fill all of the required documents. They are mostly the same forms as the original study permit application, so you can use your old form to guide you through the filling process.
- Submit, pay (~$140 + $85 for biometrics)
- Wait. Processing times are longer for extensions. Currently it's estimated to be around 140 days.
- They may contact you to provide biometrics, in that case, make an appointment and go to the office.

 Current required documents are:
 
 - Form IMM5709 filled and validated
 - Legible copy of pages of your passport bearing personal information and the photo. **Passport must be valid for the entire period of your extension.**
 - A recent digital photo (passport photo format) of you
 - Official letter from registrar that you are a full-time student and the number of credits obtained
 - Proof of financial capacity (Letter from your supervisor to give you money or an official letter from scholarship)
 - (Additional: You can include your payment proof for the last three semesters from UQAM to show that you are receiving money. Download the proofs on the human resources website [here](https://rhu.uqam.ca/index.aspx?id=p693). Choose 'Relevé de paie' and choose 'without Code MS' to log-in.)
 
> *NEW:* since July 2022: You can leave Canada and come back while you are waiting for your study permit extension. If you have to leave while you are waiting, make sure that your electronic travel authorization (eTA) or visitor visa is **not expired**. If your study permit is not extended by the time you arrive in Canada, you will be let in as a visitor and you are not allowed to study until you receive your study permit. A boder officer might ask you to prove that you have enough money to support yourself, a copy of your extension applicaiton, the payment fee receipt or any other document to prove that you have applied for an extension. For more info check this [Q&A](https://www.cic.gc.ca/english/helpcentre/answer.asp?qnum=1308&top=15).
...
> **Tip**: Whenever you renew and receive your new study permit, you need to visit the Social Insurance Number office to update them with your new permit to keep your SIN status up-to-date!
...
You are allowed back into Canada if you leave during your implicit status, if you have a valid eTA or visitor visa. However, you will not be covered by your health insurance during this period. If your implicit status prolongs, you may not be able to receive your stipend. Therefore, it is important to apply to your extension ahead of time.
...
### 1. Apply for Labour Market Impact Assessment (LMIA) exemption and employment offer

Before you can apply to the official government documents, you will need to to apply for an LMIA exemption and an employment offer number through UQAM. You need to use this employment offer number when you submit your application for a work permit online because it allows the IRCC (Immigration, Refugees and Citizenship Canada) to connect your request with the official offer from your employer (UQAM).

If you have any questions regarding the registration process contact UQAM through:
...
For some examples of clinics and medical labs, please refer to the [doctor list](#doc-list).

---

### 5. Student Card
Once you have a registration number, as a post-doc and research intern, you get a student card and get access to the buildings, student benefits and the gym. All instructions can be found [here](https://coci.uqam.ca/). 48h after submission, you can retrieve your card at DS-R502 ([Map](https://plancampus.uqam.ca/pavillon-ds)) Consult the opening hours [here](https://coci.uqam.ca/nous-joindre/). Bring your passport for ID confirmation.
...
In case your working permit ends before your actual end-of-contract (e.g. through to an extension of the contract), it is required that you extend your work permit. Similar to when you apply to the work permit for the first time, you will need to first apply for an LMIA (labour market impact assessment) exemption and an employment offer number through UQAM.
...
There are various software that you can access through UQAM (e.g. JMP, SPSS, etc.). To see which programs you can download, check [here](https://servicesinformatiques.uqam.ca/services/Laboratoire%20virtuel). You can log-in to the  [*virtual lab*](https://labvirtueluqam.cloud.com/) to download the software.
...
## 6. Available computers and platform for collaborations

At the CarBBAS Lab we have several computers that are being shared among the students and Post-docs. Yves' Lab also has a GIS computer available for use. But in general, we share computer resources among the two Labs. So as a Yves' student, you can also use the CarBBAS computers as long as you follow the rules and the calendar of each computer.

In brief, we have:

* GIS computer with Windows (has ArcMap)
* Multi-purpose computer with Windows and Linux (Windows partition has MATLAB)
* Molecular computer with Linux (high RAM and processing power)

To gain insight into the rules and the set-up to use these computers internally at UQAM or through remote access please ask someone to send you the *"ComputersAndRemoteAccess.html"* file. This file contains some secure information, so it is not being shared publicly.

---

### Github organization account

The CarBBAS Lab owns also a Github organization account that we use to collaborate, host this guide's source code and can be used to share codes used for publications publicly.

To join this [Github organization](https://github.com/CarBBAS), please create your own personal Github account if you haven't done so already and ask someone already in the Github organization to add you.

This Github account also hosts the manual for the above mentioned available lab computers, so you will automatically have access to the *"ComputersAndRemoteAccess.html"* file in the *carbbas_computers* repository, once you're a member.
...
## 8. Groupe de Recherche Interuniversitaire en Limnologie (GRIL)

The GRIL is a provincially-funded research group with members in different universities. At UQAM (aptly named GRIL-UQAM), the group consists of 10 different professors (Yves Prairie, Paul del Giorgio, Beatrix Beisner, Alison Derry, Cassandre Lazar, Philippe Juneau, Dolors Planas, Maikel Rosabal, Michelle Garneau and Marie Laroque), their students, post-docs and research professionals. Here is the group's [webpage](https://gril.uqam.ca/).

Katherine Velghe ([E-mail](velghe.katherine@uqam.ca)) is the research professional who works for the GRIL-UQAM. Her office is located at SB-2305. She is a good resource for lab/field equipment, lab training and techniques, truck management (insurance), building access, mailing lists, keys and printers. Contact her for the GRIL-UQAM welcome document that has information about day-to-day functioning in the research group. 

### Become a GRIL member
Typically, every student and post-doc who starts working with a GRIL professor joins this society. GRIL also organizes an **Annual symposium** around March and a **student workshop** in autumn (it's a 'student' workshop, but post-docs are very welcomed).
...
## 12. List of doctors / medical labs {#doc-list}

Some clinics without appointment fee for students:
...
| Clinic | Price | Appointment | Notes
|--|:--:|:--:|-----|
| [Metro-Medic](http://www.metromedic.com/) | C$ 140 | E-mail: [info@metromedic.com](info@metromedic.com) | Open 7 days a week, 24h pharmacy close by on 1500 Rue St-Catherine W
| [Forcemedic clinics](https://www.forcemedic.com/) | C$ 160 | Online, registration start: 7 pm the day before
| [Clinique 1851](https://bonjour-sante.ca/uno/clinique/1851) | ? | Online, registration start: 8 pm the day before

### Specialists

To go to a specialist, you always need a referral. Go to one of the walk-in clinics or your family doctor before.

| Speciality | Clinic | Doctor | Price | Appointment | Notes
|--|:--:|:--:|:--:|:--:|------|
| Urology | [RocklandMD](https://www.rocklandmd.com/en/) Town of Mount Royal Clinic | Dre. Genevieve Desbiens | C$ 325 | Online form | Speaks English, very nice doc. Desjardins covers C$ 250
| Gynecology | [Curel-Med](http://www.curelmed.ca/) | Dr. Pira Korsieporn | C$ 160 | Online form | Very nice doctor, speaks English. Clinic reception not very friendly. Avoid other docs in the clinic.
| Chiropractor | [Clinic Chiropratique Vision](https://visionsante.ca/en/chiropractor-our-services/) | Dr. Hani Karout | Regular visit: C$ 40 | Online or phone | Overall good experience. First visit around C$ 90
| Chiropractor | [Kiroclinique](https://kiroclinique.ca/en/) | Dre. Diana Al Ayoubi | Student: C$ 45, Regular: C$ 65 | Online or phone | First visit: C$ 125 for students, $140 regular. Very nice doctor! Desjardins pays up to $500/yr.

### Private medical labs

If you need specific lab tests done, one option to ask if they offer that test in the clinic you are going. Otherwise, you will have to go to a specific laboratory.

| Test type | Clinic | Appointment | Notes
|----|:--:|:--:|------|
| Ultra-sound, MRI, X-ray | [IRM Sud-Ouest](https://mobi.irmsudouest.com/) | Call | Friendly staff, English speaking
| Ultra-sound, MRI, X-ray | [Leger Radiologie](https://legerradiologie.qc.ca/) | Best call or email | Accepts RAMQ, only French
| Blood tests and others | [Dynacare](https://www.dynacare.ca/find-a-location.aspx) | Online | Has many labs across Montreal. Quick appointments.

Most of these offer lab tests that are covered at 100% by Desjardins Insurance as long as they are requested by a doctor.

### Dentists

You can get a cleaning treatment once a year if you pay for dental insurance through UQAM. Additionally, if you choose your dentist wisely and they offer some student discount, the treatment can become free of charge.

| Clinic | Appointment | Notes
|----|:--:|-------|
| Clinique Dentaire Villeray | Call | 57 Rue Villeray, Montréal, QC H2R 1G2; Students 30% off.
| [Clinique Dentaire La Cité](https://www.cliniquedentairelacite.com/en/) | Email | English-speaking Dentist that directly sends the insurance form to ASEQ, hence, you only have to pay the proportion that is not covered by our insurance. The clinic also has various student discounts if you need further treatments. The discount on cleaning is enough so that your annual dental cleaning would be free.

**Warning**: Some dentists try to scam you. Usually, the first X-ray is necessary but you don't need to do an X-ray every year. If they suggest treatments, you don't have to accept. You can always say no. If you agree to get some treatment done, you could try and ask for a written consent form that outlines that you only want the treatment that you initially agreed upon.
...
- *Dejardins Insurance* currently offers CAD$500 per coverage year with a CAD$50 deductible on your first appointment, with the maximum of CAD50 applied per visit. 
...
## 14. Budget and living expenses {#budget}
...
## 15. Safety in Montréal
In general, Montréal is a relatively safe city. However, there are thieves and one has to be careful about certain things.

* Bike theft is a big business in Montréal. If you have a bike, the more expensive / better the more dangerous it is to get it stolen. Make sure to get at least one U-lock (don't get any of the curly locks that are easily broken). If you have a good bike, get two U-locks or another chain lock to secure both tires and the frame. Securely lock it if you store the bike anywhere outside. Most apartments in Montréal have emergency stairs to balconies, so lock it even when you leave it on your balcony.

* If you live in an apartment with access to a smaller back street (e.g. through balcony), most thieves try to enter through these back streets because there are few people watching. Make sure not to leave balcony doors open when you're not in the room. Even if you're inside the apartment, they may sneak in and steal something quickly to grab while you're in another room.

* Consider getting a home-insurance for renters. They are relatively inexpensive (e.g. 30$ per month for a small apartment) and will help you recover money in case of theft, fire, and other incidences.

* Problems with landlords can happen. However, Montréal is a city with greater protection for the renter. If you have problems with your landlords, or even before signing any rental contract make sure to go through the basic laws. For example, asking the renter for an additional deposit is not legal in Québec. They are only allowed to ask you to pay the first month of rent prior to your move, but many landlords do ask for an additional security deposit. Unfortunately, the apartment market in Montréal is particularly bad, thus you may loose your opportunity to the apartment if you refuse to pay the additional deposit. Ask your landlord to give you a receipt and make him/her include in the contract that the landlord needs to fully pay back the deposit when you leave the apartment. If you have other problems with your landlord, e.g. not willing to fix broken things in your apartment, you can contact the [*Tribunal administratif du logement*](https://www.rdl.gouv.qc.ca/en) and they can interfere and help you.
...
Before/after you move, you should update your address (at least) at the following sites:

- UQAM portal ([Portail étudiant](https://portailetudiant.uqam.ca/) for students; for postdocs ?)
- [UQAM Human resources](https://rhu.uqam.ca/index.aspx?id=p629) (through sans code MS for students; with code MS for postdocs)
- [Canada Revenue Agency](https://www.canada.ca/en/revenue-agency/services/e-services/cra-login-services.html)
- [Québec Revenue Agency](https://citoyens.revenuquebec.ca/CitNA/TW/TW01/TW01.CitoyensNA/IDP/?AuthLevel=600&TYPE=33554433&REALMOID=06-9fb5eeb9-6772-49ed-998f-77e6869754b1&GUID=&SMAUTHREASON=0&METHOD=GET&SMAGENTNAME=-SM-fEqsYN7tvijETL4BxEFHliHeRjImmjXkIsKDGTL7vJJgfzFMlc5hLBbea7EJOEn%2b&TARGET=-SM-HTTPS:%2f%2fcitoyens.revenuquebec.ca%2fCitPres%2fSX%2fSX00%2fSX00.SXCLT00A.AccueilClient%2fSXCLT00AA%3fSVAR%3d01%26connexion%3dCitoyens)
- Health Insurance ([Desjardins](https://id.desjardins.com/login?state=hKFo2SBnQVRTbkpIWWZsWFFuNEVPUkNIbzBwVWs4bE9wLXhaX6FupWxvZ2luo3RpZNkgb3A1czR1ZTF2clNCbXgyVW1uX24waTRDbFNUNUc5clmjY2lk2SAyT3NNQkpIVzN4UDNscXlObEt1WmVSQUF2bXJFaUJnMQ&client=2OsMBJHW3xP3lqyNlKuZeRAAvmrEiBg1&protocol=samlp&wa=wsignin1.0&wtrealm=https%3A%2F%2FICA&wctx=rm%3D0%26id%3Dpassive%26ru%3D%252fAGEA-GBIM%252fDefault.aspx&wct=2022-03-10T20%3A52%3A48Z&whr=http%3A%2F%2Fauth.desjardins.com%2Ftrust%2Finitial&wreply=https%3A%2F%2Fwww.agea-gbim.dsf-dfs.com%2FAGEA-GBIM%2FDefault.aspx&connection=gpap&RelayState=RPID%3Dhttps%253a%252f%252fICA%26RelayState%3D%252fAGEA-GBIM%252fDefault.aspx&ui_locales=en&tenant=desjardins))
- RAMQ (?)
- Your Bank

Some sites offer to set a 'effective date' of address change.

### Outside of Montréal

It's sad to see you go, but that's life! If you have a nice/cheap apartment, consider asking around at the GRIL-UQAM and see if there are any new students/postdocs expected to come around the time you are leaving. It would save you time and hassle to find someone to take over your lease, if you leave before your lease is over. And, you would do a overwhelmed newcomer a favour!
