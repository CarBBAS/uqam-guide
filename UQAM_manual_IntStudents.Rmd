...
date: 'Last updated on: 23 June 2020'
output:
  html_document:
    self_contained: yes
    toc: yes
...
**Physically**, you can find this form in the biology department room in PK building, then ask your PI to sign and fill their sections to receive your stipend. Once the documents are complete you can submit it to the same biology office that you get the form from. If you have a research associate in your lab he/she will aid you in the process if anything is unclear.
...
Unfortunately, we cannot have access to all the other insurances provided by ASEQ as international students at UQÀM (e.g. travel insurance).
...
We have several labs that are shared among research groups part of the Groupe de recherche interuniversitaire de limnologie (GRIL) at UQAM. To get access to the labs, get the key **NE 91** from the person responsible for the GRIL laboratories (CAD$5 cash deposit).
...
Fill out the first three sections of the report and sign in the tiny space in the fourth section as the 'demandeur or demandresse'. Your lab's research assocaite can help you with the report and she/he will need to look over it, add the account number, sign, and keep a copy before it goes down to the secretary in SB-R860. The secretary will also look it over before sending it to UQAM financial services.
