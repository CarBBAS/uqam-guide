...
### 4. Sign stipend form
Once the main things have been settled ask Alice (for Paul’s students) or Yves to sign the form to receive your stipend. It can take more than a month until you receive your first payment!
...
Each semester, you have to register for a course. To do so, send an email to [Cécile Poirier](<mailto:cyclesupbiologie@uqam.ca>) with the code for the course.
...
In case you have troubles setting up **eduroam** you can ask Alice or Sara to get you a temporary visitor access.
