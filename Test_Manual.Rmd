...
output:
  html_document:
    ...
    toc_float: true
---
<!-- Navigating to sepcific section: -->

<!-- * [A few words](#a-few-words) -->
<!-- * [Students](#students) -->
<!--     + [Before Arrival](##before-students) -->
<!--     + [After Arrival](##after-students) -->
<!-- * [Post-docs](#post-docs) -->
<!-- * [Universal](#universal) -->
...
Here are some things that you will need to do before arriving in Canada:
...
### 6. UQÀM Online Portal for students
...
<details>
  ...
  **Important**: As an international Master student, one has to pay the extra fee for foreign students. To get exempt of this, apply to an **exemption scholarship** on [RIBÉ](https://www.apps.uqam.ca/application/bourses/login/login.aspx). Log-in with your:
  ...
  * NIP
  ...
  Go to *'Recherche bourses'* (Search scholarship) and look for a foreigner student fee exemption scholarship and apply.
...
<details>
  ...
  * From the *‘Total’* amount at the very bottom of the page, subtract the *‘Frais majorés étudiant étranger’* (Higher fees for foreign students)
  ...
  Make sure to provide your *‘Code de paiement’* (Payment code) listed at the beginning of the page when you make the payment via bank transfer. Expect a tuition between 1000 - 2800$ depending on which semester. Usually, you pay more in the autumn semester, because one pays additionally the health insurance.
  
</details>

### 10. Register to a class
...
### 15. Extending your study permit
...
Additionally, you will need to ask UQÀM for documents to prove that you are a student. Visit the registrary to get all your documents. If you tell them that you need all the documents to renew your study permit, they will give you all you need. You will have to pay for the documents (~$35). Make sure to scan your UQÀM documents. You will need to send the original documents for the CAQ application, but the study permit only requires the electronic scan.

> **Tip**: Whenever you renew your study permit, you need to update your social insurance number after you have received your new study permit!
...
# Post-docs (and research internship) {#post-docs}
## Before arrival {.tabset}
### 1. UQÀM
...
### 3. Registration
Visit Alice after you got your SIN and a bank account to fill the registration form and get a registration number.
...
## 2. Access to labs and keys
  We have several labs that are shared among the universities at UQÀM. To get access to the labs, get the key **NE 91** from Katherine ($5 deposit in cash).
You can also get keys to other labs and offices. Our key manager, Sylvie Guilbeault, is located in the RC floor of the SB-building (SB-R860). Usually, a deposit of around $10 (in cash) for each key is necessary. You will get this money back, once you give the key back.
...
We hope that with all these new information, you will have a smooth transition to live in Montreal. Please do not hesitate to contact any of your cohorts or your advisor for any questions and additional help.
